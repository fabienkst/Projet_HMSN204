...
while column in range(1,n+1) or ligne in range (1,p+1):
...
decoupseq2=""
i=1
decoupseq1=str(i)+"  "+finalseq1[0:79]
decoupsep=str(i)+"  "+finalsep[0:79]
decoupseq2=str(i)+"  "+finalseq2[0:79]
rest1=""
restsep=""
rest2=""
...
while i in range(r1):
	decoupseq1=str(i)+"  "+rest1[0:79]
	decoupsep=str(i)+"  "+restsep[0:79]
	decoupseq2=str(i)+"  "+rest2[0:79]
	i=i+80
