...
maseq = Entrez.esearch(db="nucleotide", term = "PGM[gene name] AND Arabidopsis thaliana[orgn] AND biomol_mrna[prop] AND phosphoglucomutase[title] AND srcdb_refseq[prop]", retmax = 10)
